import { generateAccount } from './index.js';
...
function printAddress(
  ...
  let result = { mnemonic: '', privateKey: '', address: '' };
  try {
    result = generateAccount(mnemonic, privateKey, accountIndex);
  } catch (err) {
    console.error(`Error: ${err.message}`);
    return;
  }

  if (!hidingMnemonic && result.mnemonic != '') {
